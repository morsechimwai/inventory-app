...
export function SiteHeader() {
  ...
  const currentPath =
    normalizePath(pathname).split("/").pop() === "dashboard"
      ? "dashboard"
      : normalizePath(pathname).split("/").pop() === "inventory-activities"
      ? "activities"
      : normalizePath(pathname).split("/").pop() === "products"
      ? "products"
      : normalizePath(pathname).split("/").pop() === "categories"
      ? "categories"
      : normalizePath(pathname).split("/").pop() === "units"
      ? "units"
